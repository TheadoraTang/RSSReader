...
|-----|-----------------------------|----------------------------| ------------------------------------------------------------------ | ------------------------------------------- |
| 唐小卉 | Week12、Week13、Week15、Week18               | 项目初始化和分工，RSS Reader 后端核心系统 | 项目初始化（Vue/FastAPI/SQLite）、SQLite 数据模型设计、RSS/Atom Feed解析、Feed API开发 | 完成 RSS Reader 后端基础架构，支持 RSS 解析、数据存储与 API 提供 |
...
| Week17 | AI翻译接口实现             | 张宥 |
| Week16 | Summary LLM用量统计        | 张宥（有困难就不做，记得把前端删掉） |
| Week17 | Mac端功能测试          | 仲韦萱 |
